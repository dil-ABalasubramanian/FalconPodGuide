...
extension View {
    ...
    public func duplicateFloatingShapes(animateShapes: Bool) -> some View {
        ZStack {
            Circle()
                .fill(Color.blue.opacity(0.5))
                .frame(width: 180, height: 180)
    ...
    // this is duplicate 2 method to verify docC
    public func duplicate2FloatingShapes(animateShapes: Bool) -> some View {
        ZStack {
            Circle()
                .fill(Color.blue.opacity(0.5))
                .frame(width: 180, height: 180)
